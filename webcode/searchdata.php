...
<div id="main">
<form method="post" action="searchdatagraph.php">
...
<h2>DATA ON <?php echo $_POST["fromdate"];?></h2>
<?php
		...
		$simp1 = "SELECT DATE_FORMAT(date_time, '%M %d %Y') AS DATE FROM monitoring WHERE date_time BETWEEN '$fromdate 00:00:00' AND '$fromdate 23:59:59';";
		$aidcon1 = mysqli_query($conn, $simp1);
		
		$simp2 = "SELECT TIME_FORMAT(date_time, '%H:%i:%s %p') AS TIME FROM monitoring WHERE date_time BETWEEN '$fromdate 00:00:00' AND '$fromdate 23:59:59';";
